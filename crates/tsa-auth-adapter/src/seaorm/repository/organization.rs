...
use super::super::entity::organization::{ActiveModel, Column, Entity};
...
impl From<super::super::entity::organization::Model> for Organization {
    fn from(model: super::super::entity::organization::Model) -> Self {
        Organization {
            id: model.id,
            name: model.name,
            slug: model.slug,
