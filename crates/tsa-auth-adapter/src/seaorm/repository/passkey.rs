...
use super::super::entity::passkey::{ActiveModel, Column, Entity};
...
impl From<super::super::entity::passkey::Model> for Passkey {
    fn from(model: super::super::entity::passkey::Model) -> Self {
        Passkey {
            id: model.id,
