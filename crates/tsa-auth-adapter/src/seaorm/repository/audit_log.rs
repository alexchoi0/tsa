...
use super::super::entity::audit_log::{ActiveModel, Column, Entity};
...
impl From<super::super::entity::audit_log::Model> for AuditLog {
    fn from(model: super::super::entity::audit_log::Model) -> Self {
