...
use super::super::entity::session::{ActiveModel, Column, Entity};
...
impl From<super::super::entity::session::Model> for Session {
    fn from(model: super::super::entity::session::Model) -> Self {
        Session {
            id: model.id,
