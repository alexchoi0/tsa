...
use super::super::entity::passkey_challenge::{ActiveModel, Column, Entity};
...
impl From<super::super::entity::passkey_challenge::Model> for PasskeyChallenge {
    fn from(model: super::super::entity::passkey_challenge::Model) -> Self {
