...
use super::super::entity::account::{ActiveModel, Column, Entity};
...
impl From<super::super::entity::account::Model> for Account {
    fn from(model: super::super::entity::account::Model) -> Self {
        Account {
            id: model.id,
