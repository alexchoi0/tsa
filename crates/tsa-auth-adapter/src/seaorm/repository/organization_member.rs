...
use super::super::entity::organization_member::{ActiveModel, Column, Entity};
...
impl From<super::super::entity::organization_member::Model> for OrganizationMember {
    fn from(model: super::super::entity::organization_member::Model) -> Self {
        OrganizationMember {
            id: model.id,
