...
use super::super::entity::organization_invitation::{ActiveModel, Column, Entity};
...
impl From<super::super::entity::organization_invitation::Model> for OrganizationInvitation {
    fn from(model: super::super::entity::organization_invitation::Model) -> Self {
