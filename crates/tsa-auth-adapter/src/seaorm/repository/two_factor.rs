...
use super::super::entity::two_factor::{ActiveModel, Column, Entity};
...
impl From<super::super::entity::two_factor::Model> for TwoFactor {
    fn from(model: super::super::entity::two_factor::Model) -> Self {
        TwoFactor {
            id: model.id,
